...
const STATE_TRANSITIONS = {
  [ORDER_STATES.CREATED]: [ORDER_STATES.VALIDATED, ORDER_STATES.REJECTED, ORDER_STATES.FAILED],
  [ORDER_STATES.VALIDATED]: [ORDER_STATES.QUEUED, ORDER_STATES.REJECTED, ORDER_STATES.FAILED],
  [ORDER_STATES.QUEUED]: [ORDER_STATES.SENT_TO_BROKER, ORDER_STATES.ACKNOWLEDGED, ORDER_STATES.FAILED],
...
class OrderStateMachine {
  constructor(initialState = ORDER_STATES.CREATED) {
