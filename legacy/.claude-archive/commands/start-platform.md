...
1. CLAUDE.md
2. .claude/roles/ROLE_07_TEAM_WORKFLOW_ORCHESTRATION.md
3. .claude/roles/ROLE_02_SENIOR_BACKEND_ENGINEER.md
4. src/strategies/intraday/strategy1Live.js
5. src/execution/orderManager/orderManager.js
6. src/risk/riskManager.js
7. src/marketData/marketDataService.js

Then read every file in src/ and __tests__/
...
Read existing __tests__/ first to avoid duplicates.
