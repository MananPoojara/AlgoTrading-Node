    ...
    try {
      ...
      if (runtimeStateSupported) {
        try {
          ...
          SELECT 
            ...
            si.runtime_state as instance_runtime_state,
        ...
        `);
          ...
          logger.warn("strategy_instances.runtime_state missing; loading legacy mappings", {
            error: error.message,
          });
          result = null;
        }
      ...
      for (const row of result.rows) {
        this.addMapping({
          ...
          runtimeState: row.instance_runtime_state || {},
